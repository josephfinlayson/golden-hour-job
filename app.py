...
def process_video(images):
    ...
    # file_data = [('image', ('long.jpg', open('./long.jpg'), 'image/jpeg')), ('image', ('long.jpg', open('./long.jpg'), 'image/jpeg'))]
    response = requests.post("https://golden-hour.hobby-paas.cf/post-story", files=file_data, data=dict(text="test1"))
    print(response)
